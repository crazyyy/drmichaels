...
<body id="page" class="page  isblog  at-boxed" hola-ext-player="1">
                            ...
                            <div class="menubar">
                                <nav id="menu">
                                    <ul class="menu menu-dropdown">
                                        <li class="level1 item101 active current"><a href="#" class="level1 active current"><span>Home</span></a>
                                        </li>
                                        <li class="level1 item107"><a href="#" class="level1"><span>About Us</span></a>
                                        </li>
                                        <li class="level1 item108 parent"><a href="#" class="level1 parent"><span>Our Team</span></a>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin="">
                                        ...
                                        <div class="uk-width-medium-1-3">
                                            <div style="text-align: center;">
                                                <div class="uk-button-group"> <a class="uk-button-color uk-button" href="#" target="_self"><i class="uk-icon-question-circle"></i> Send Enquiry</a>  <a class="uk-button-color uk-button" href="#" target="_self"><i class="uk-icon-pencil"></i> Appointment</a> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="wrapper">
                                <div>
                                    <div class="uk-alert uk-alert-announce" data-uk-alert="">
                                        <a href="#" class="uk-alert-close uk-close"></a> <span class="infotip bg-green">Newsflash <i class="uk-icon-bullhorn"></i></span> Dr. Michael's Dental Clinic Wins Excellent Customer Service Award <span class="infotip-link"><a href="#" target="_self">READ MORE</a></span>
                                    </div>
                                </div>
                                <div class="uk-grid" data-uk-grid-margin="">
                                    <div class="uk-width-medium-1-3">
                                        ...
                                        <div class="ind-button"><a class="uk-button-primary uk-button-small uk-button" href="#" target="_self">more info <i class="uk-icon-chevron-circle-right"></i></a>
                                        </div>
                                    </div>
                                    <div class="uk-width-medium-1-3">
                                        <div itemscope="" itemtype="http://schema.org/LocalBusiness">
                                ...
                                <div class="wrapper">
                                    <div class="uk-grid" data-uk-grid-margin="">
                                        <div class="uk-width-medium-1-2">
                                            ...
                                            <h2><p style="text-align: center;"><a class="uk-button-color uk-button" href="#" target="_blank">GET STARTED</a></p></h2>
                                        </div>
                                        <div class="uk-width-medium-1-2">
        ...
        <div id="bottom-c">
                            ...
                            <div class="wrapper">
                                <div class="uk-grid" data-uk-grid-margin="">
                                    <div class="uk-width-medium-1-3">
                                        ...
                                        <ul class="uk-list list-icons">
                                            <li><i class="uk-icon-smile-o"></i><a href="#" target="_blank">Couture Smiles by Dr. Michael</a>
                                            </li>
                                            <li><i class="uk-icon-smile-o"></i><a href="#">Smiles by Dr. Gun Ingrid-Norell</a>
                                            </li>
                                            <li><i class="uk-icon-smile-o"></i><a href="#">Root Canal Cases by Dr. Yasmin</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="uk-width-medium-1-3">
                                        ...
                                        <ul class="uk-list list-icons">
                                            <li><i class="uk-icon-7s-link"></i><a href="#" target="_blank">Safiyah Adham, up close &amp; personal</a>
                                            </li>
                                            <li><i class="uk-icon-7s-link"></i><a href="#" target="_self">Most advanced dental imaging technology</a>
                                            </li>
                                            <li><i class="uk-icon-7s-link"></i><a href="#" target="_blank">What changes when you lose all your teeth?</a>
                                            </li>
                                            <li><i class="uk-icon-7s-link"></i><a href="#" target="_blank">A review from ExpatWoman</a>
                                            </li>
                                        </ul>
                                        <div class="ind-button"><a class="uk-button-primary uk-button-small uk-button" href="#" target="_blank">Dental Blog <i class="uk-icon-chevron-circle-right"></i></a>
                                        </div>
                                    </div>
                                    <div class="uk-width-medium-1-3">
                                        <p class="col-title2 underline"><i class="uk-icon-coffee"></i> The Newsroom</p>
                                        <ul class="uk-list list-icons">
                                            <li><i class="uk-icon-7s-news-paper"></i><a href="#">Excellent customer service award</a>
                                            </li>
                                            <li><i class="uk-icon-7s-news-paper"></i><a href="#">Walk for education 2015</a>
                                            </li>
                                        </ul>
                                        <div class="ind-button"><a class="uk-button-primary uk-button-small uk-button" href="#" target="_self">Newsroom <i class="uk-icon-chevron-circle-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div id="copyright">
                <div class="module   deepest">
                    <div>
                        <div class="wrapper">
                            <p>© Copyright 2015 <a href="#" rel="author">Dr. Michael's Dental Clinic</a>, Dubai, UAE • All Rights Reserved • MOH Approval No. WK87683 (02.02.2016) • 50&nbsp;guests online</p>
    ...
    <a id="totop-scroller" href="#" data-uk-smooth-scroll=""></a>
        ...
        <div class="uk-offcanvas-bar">
            <div class="module canvas-menu  deepest">
                <ul class="menu uk-nav-offcanvas">
                    ...
                    <li class="level1 item108 parent uk-nav-offcanvas"><a href="#" class="level1 parent uk-nav-offcanvas"><span>Our Team</span></a>
    ...
    <script type="text/javascript" src="js/app.js"></script> <a href="#" class="uk-icon-angle-up" title="" id="toTop" style="display: none;"><span id="toTopHover"></span></a>
